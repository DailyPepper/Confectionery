...
<template>
<PopupFailure v-if="isPopupFailure" :show="isPopupFailure" @update:show="isPopupFailure = false"/>
<PopupFailureEdit v-if="isPopupEdit" :show="isPopupEdit" @update:show="isPopupEdit = false"/>
